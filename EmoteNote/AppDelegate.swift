...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        // this displays an onboarding screen where the user first enters their passcode; if already entered, goes to the mainscreen (tableview controller for diary enteries)
        ...
        if (UserDefaults.standard.value(forKey: "passcode") as? String) == nil {
            ...
            // show note tableview controller
